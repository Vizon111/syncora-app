...
export function AiTaskBreakdown({
  ...
  return (
    <div className="space-y-4 pt-2 border-t border-neutral-800/80">
      ...
      <div className="p-3 bg-gradient-to-br from-indigo-950/40 via-neutral-900/60 to-purple-950/30 border border-indigo-500/20 rounded-xl">
            ...
            <button
              ...
              className={`p-1.5 rounded-lg border transition-colors ${
                showOptions
                  ...
                  : 'bg-neutral-950/60 border-neutral-800 text-neutral-400 hover:text-neutral-300'
              }`}
        ...
        {showOptions && (
          <div className="mt-3 pt-3 border-t border-neutral-800/80 animate-in fade-in">
            <label className="block text-2xs font-semibold text-neutral-400 mb-1">
            ...
            <input
              ...
              className="w-full px-2.5 py-1.5 text-xs bg-neutral-950/80 border border-neutral-800 rounded-lg text-neutral-200 placeholder-neutral-500 focus:outline-hidden focus:border-indigo-500"
            />
          </div>
        )}
        ...
        {(suggestedLabels.length > 0 || suggestedPriority || suggestedStoryPoints || suggestedEstimatedHours || complexityReasoning) && (
          <div className="mt-2.5 pt-2.5 border-t border-neutral-800/60 space-y-2 text-2xs">
            ...
            {complexityReasoning && (
              <div className="p-2 rounded-lg bg-neutral-950/60 border border-indigo-900/30 text-neutral-300 text-[11px] leading-relaxed">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <label className="text-2xs font-bold text-neutral-300 uppercase tracking-wider flex items-center gap-1.5">
            <CheckSquare className="w-3.5 h-3.5 text-indigo-400" />
            {t.tasks.aiSubtasksHeading}
            <span className="text-2xs font-mono text-neutral-400 bg-neutral-800 px-1.5 py-0.2 rounded">
              {subtasks.length}
            </span>
          </label>
        </div>
        ...
        {subtasks.length > 0 && (
          <div className="space-y-1.5 max-h-48 overflow-y-auto pr-1 custom-scrollbar">
            {subtasks.map((sub) => (
              <div
                key={sub.id}
                className="group flex items-center justify-between gap-2 px-2.5 py-1.5 rounded-lg bg-neutral-950 border border-neutral-800/80 hover:border-neutral-700 transition-all text-xs"
              >
                <div
                ...
                >
                  <input
                    ...
                    onChange={() => {}}
                    className="rounded border-neutral-700 text-indigo-600 focus:ring-0 cursor-pointer w-3.5 h-3.5"
                  />
                  <span
                    className={`truncate ${
                ...
                <button
                  ...
                  className="opacity-0 group-hover:opacity-100 p-1 text-neutral-500 hover:text-rose-400 hover:bg-neutral-800 rounded transition-all"
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-2.5 py-1.5 text-xs bg-neutral-950/70 border border-neutral-800 rounded-lg text-neutral-200 placeholder-neutral-500 focus:outline-hidden focus:border-indigo-500"
          />
          <button
            type="button"
            onClick={() => handleAddSubtask()}
            disabled={!newSubtaskText.trim()}
            className="px-2.5 py-1.5 text-xs font-semibold bg-neutral-800 hover:bg-neutral-700 disabled:opacity-40 text-neutral-200 rounded-lg transition-colors inline-flex items-center gap-1"
          >
      ...
      <div className="space-y-2">
              ...
              >
                ...
                >
                  <input
                    ...
                    checked={c.satisfied}
                    onChange={() => {}}
                    className="mt-0.5 rounded border-neutral-700 text-emerald-600 focus:ring-0 cursor-pointer w-3.5 h-3.5"
                  />
                  <span
                    className={`text-xs ${
                      c.satisfied ? 'line-through text-neutral-500' : 'text-neutral-200'
                    }`}
                  >
                    {c.text}
                  </span>
                ...
                <button
                  ...
                  className="opacity-0 group-hover:opacity-100 p-1 text-neutral-500 hover:text-rose-400 hover:bg-neutral-800 rounded transition-all shrink-0"
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-2.5 py-1.5 text-xs bg-neutral-950/70 border border-neutral-800 rounded-lg text-neutral-200 placeholder-neutral-500 focus:outline-hidden focus:border-emerald-500"
          />
          <button
            type="button"
