...
import { X, Link2, Copy, Check, Loader2, Power, ExternalLink, Sparkles, RefreshCw } from 'lucide-react';
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="pt-4 border-t border-slate-200 dark:border-neutral-800 space-y-3">
            <div className="flex items-center justify-between">
              <h4 className="flex items-center gap-1.5 text-2xs font-bold uppercase tracking-wider text-slate-400 dark:text-neutral-500">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-2xs font-semibold text-indigo-600 bg-indigo-50 border border-indigo-200 hover:bg-indigo-100 dark:text-indigo-300 dark:bg-indigo-600/15 dark:border-indigo-500/30 dark:hover:bg-indigo-600/25 disabled:opacity-50 transition-colors"
              >
                {isGeneratingDigest ? (
            ...
            {digest ? (
              ...
              <p className="text-2xs text-slate-400 dark:text-neutral-600">
